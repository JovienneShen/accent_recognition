...
if __name__ == "__main__":
    ...
    ckpt = torch.load(f"{hparams['pretrained_path']}/embedding_model.ckpt")
    accid_brain.modules.embedding_model.load_state_dict(ckpt)
    ckpt = torch.load(f"{hparams['pretrained_path']}/classifier.ckpt")
    accid_brain.modules.classifier.load_state_dict(ckpt)
